...
import PersonalizedHero from '../sections/personalized/PersonalizedHero';
import StrategyContent from '../sections/personalized/StrategyContent';
...
// Personalized navbar links (per Dream100 spec)
const navLinks = [
...
// "Some of Our Work" grid — same as the main site, with the Jordan Bazzouzi
// slot swapped for the requested video (hkdgu3Dv5NM). The rest is unchanged.
