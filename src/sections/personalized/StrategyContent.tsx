...
const funnelStages: { stage: Stage; num: string; en: string; ar: string; icon: typeof Search; body: string }[] = [
  ...
  },
  {
    ...
    ar: 'التحويل',
    icon: Target,
    body: `هذه هي مرحلة الحصاد. الفيديوهات هنا موجهة للأشخاص الذين يمتلكون نية عالية للشراء. نعالج فيها الاعتراضات الشائعة (مثل "هل هذا المجال مناسب لي؟" أو "هل السعر مبرر؟")، ونستعرض قصص نجاح حقيقية لطلاب حققوا بين ٢٠٠٠ إلى ٧٠٠٠ دولار. الهدف المباشر من هذه الفيديوهات هو توجيه المشاهد المؤهل لحجز استشارة فردية.`,
  },
];
...
const videoIdeas: VideoIdea[] = [
  ...
  {
    stage: 'TOF',
    title: 'كيف تعمل دخل من البيت بدون رأس مال (دليل مهارة الـ High-Ticket Sales)',
    ...
    cta: 'تحميل دليل الدخول لعالم الـ High-Ticket Sales.',
  },
  {
    stage: 'TOF',
  ...
  {
    stage: 'TOF',
    title: 'أسهل مهارة تدخلك ٥٠٠٠$ شهرياً من بيتك (بدون رأس مال أو شهادة)',
    angle: 'تقديم الإغلاق عن بُعد كأسهل مهارة عالية الدخل — بلا رأس مال ولا مخزون ولا شهادة.',
    intent: 'يريد دخلاً من الإنترنت بأقل مجهود، وقد حسم رغبته لكنه لم يختر "كيف" بعد.',
    premise: 'الكشف عن أن المهارة هي إغلاق صفقات الـ High-Ticket عن بُعد، ولماذا تتسابق الشركات لدفع ٣٠٠٠–١٠٠٠٠$ شهرياً لمن يتقنها، وكيف يبدأ المشاهد من الصفر.',
    thumbnail: 'صورة بإطار راقٍ وأنتِ على اللابتوب، مع نص "من البيت" أو "بدون شهادة" (دون رقم الدخل لأنه في العنوان).',
    cta: 'مشاهدة فيديو MOF يشرح آلية الإغلاق عن بُعد خطوة بخطوة.',
  },
  {
    stage: 'TOF',
    title: 'إذا عمرك بين ٢٠ و٣٥ وحاسس إنك متأخر عن الحياة — شاهد هذا الفيديو',
    angle: 'مخاطبة قلق العمر — "أنا بأهدر أحلى سنيني والكل حولي عم يسبقني".',
    intent: 'شخص في العشرينات أو الثلاثينات يشعر أنه عالق ويرى أقرانه يتقدمون، فيبحث عن السبب وعن مخرج.',
    premise: 'التحقق من ألم المشاهد أولاً، ثم كشف أن القرار الوحيد الذي يفصل من يتقدّم عمن يبقى مكانه هو إتقان مهارة عالية الدخل، مع ربطها بضغوط سوق العمل العربي.',
    thumbnail: 'نظرة جادة إلى الكاميرا مع عنصر يوحي بمرور الوقت (ساعة أو تقويم)، ونص "متأخر؟" أو "وقتك عم يخلص".',
    cta: 'مشاهدة فيديو MOF يشرح ما هو الإغلاق عن بُعد بالتفصيل.',
  },
  {
    stage: 'TOF',
    title: 'لماذا أنت فقير؟ (الإجابة ليست ما تتوقعه)',
    angle: 'تشخيص سبب التعثر المالي — لا غياب الفرصة، بل معتقدات عربية مزروعة عن المال والبيع وقيمة الذات.',
    intent: 'يشعر أن علاقته بالمال نفسها معطوبة، ويبحث عمن يفسّر له لماذا يبقى عالقاً رغم محاولاته.',
    premise: 'تفكيك ٥ معتقدات يزرعها المجتمع العربي عن المال (عيب البيع، عبادة الشهادة، الوظيفة الحكومية)، وإعادة تأطير "البيع" من شيء معيب إلى مهارة الثروة الأولى، تمهيداً للإغلاق عالي القيمة كتطبيق عملي.',
    thumbnail: 'تعبير جادّ مع تباين بصري بين "قيود" و"تحرر"، ونص "تمت برمجتك" أو "المجتمع كذب عليك" (دون كلمة "فقير").',
    cta: 'مشاهدة فيديو MOF عن شكل مبيعات الـ High-Ticket الحديثة.',
  },
  {
    stage: 'TOF',
    title: 'أفضل مهارة تتعلمها المرأة العربية في ٢٠٢٦ لتحقيق استقلالها المالي',
    angle: 'مهارة مهنية محترمة تُمارَس بالكامل من المنزل، مصمَّمة لاستقلال المرأة العربية مالياً.',
    intent: 'امرأة عربية تريد دخلاً مستقلاً لكنها تشعر أن خياراتها محدودة بحكم ظروفها.',
    premise: 'كشف أن إغلاق الـ High-Ticket هو المهارة المثالية للمرأة لأنه يعتمد على قوة الإصغاء والتواصل، ويُمارَس عن بُعد، ويدفع ٣٠٠٠–٨٠٠٠$ شهرياً — وأنتِ نفسك الدليل الحيّ على ذلك.',
    thumbnail: 'وقفة واثقة بإطار راقٍ يوحي بالاحتراف لا بالاحتيال، مع نص "للنساء" أو "من البيت".',
    cta: 'تدريب مجاني مخصّص للنساء اللواتي يردن البدء بهذه المهارة (ماستر كلاس).',
  },
  {
    stage: 'TOF',
    title: '٧ تصرفات بسيطة تدمر هيبتك أمام العميل (بدون أن تدرك)',
    angle: 'تهديد المكانة — الإيحاء بأن المشاهد يُضعف قيمته أمام العميل دون أن يشعر.',
    intent: 'يظن نفسه مهذباً ومحترفاً، لكنه يخشى أن يبدو ضعيفاً أو "محتاجاً" في مكالماته.',
    premise: 'تفكيك ٧ سلوكيات لا واعية تخفض مكانتك فوراً في مكالمة المبيعات، وكيف تقلب موازين القوة لصالحك في لحظتها.',
    thumbnail: 'تعبير واثق وقوي، مع نص يلمّح إلى ثنائية الضعف والقوة دون فضحها.',
    cta: 'تحميل "سكريبت الإغلاق عالي المكانة"، أو التوجيه إلى الماستر كلاس.',
  },
  {
    stage: 'TOF',
    title: 'إذا كنت تريد تحقيق ثروة في ٢٠٢٦، شاهد هذا الفيديو (٣ مسارات)',
    angle: 'إطار طموح يستخدم السنة الجديدة وتقسيماً منطقياً يَعِد ببناء الثروة.',
    intent: 'مبتدئ يبحث عن خارطة طريق واقعية للثروة بعيداً عن الوظيفة وبلا رأس مال كبير.',
    premise: 'استبعاد الدروب شيبينغ والكريبتو، وعرض ٣ مسارات واقعية لبناء الثروة، مع تبيان لماذا الإغلاق عالي القيمة هو الأقل مخاطرة والأعلى عائداً للسوق العربي الآن.',
    thumbnail: 'خلفية احترافية مع نص "٣ مسارات" أو "خارطة الطريق".',
    cta: 'مشاهدة فيديو يعرّف المبتدئين بمهارة الإغلاق عن بُعد.',
  },
  {
    stage: 'MOF',
  ...
  {
    stage: 'MOF',
    title: 'كيف تمنع أي اعتراض قبل أن ينطقه العميل (تدريب شامل)',
    angle: 'الماستر كلاس الكاملة — حل نهائي وشامل لأكبر وجع في المبيعات: الاعتراضات.',
    intent: 'يريد إطاراً متكاملاً يخلّصه من اعتراضات السعر والثقة والوقت دفعة واحدة.',
    premise: 'إطار عملي يفكّك الاعتراضات في مرحلة الاكتشاف قبل ذكر السعر، حتى يصبح الجواب الوحيد عند طرحه هو "نعم".',
    thumbnail: 'وقفة الخبيرة الواثقة مع نص يوحي بالشمول مثل "تدريب كامل".',
    cta: 'جسر مباشر إلى برنامج Elite Sales Mastery المدفوع.',
  },
  {
    stage: 'MOF',
    title: 'كيف تستخدم "الصمت" كسلاح فتاك في المبيعات (سر الـ ١٪)',
    angle: 'السلاح السري — أخذ مفهوم معاكس للبديهة (ألا تتكلّم) وتأطيره كمهارة نخبة.',
    intent: 'بائع يريد تكتيكاً متقدماً يطبّقه فوراً ويرى أثره في مكالمته القادمة.',
    premise: 'المبتدئ يخسر الصفقة بكثرة الكلام، بينما المحترف يستخدم الصمت الاستراتيجي ليخلق ضغطاً نفسياً يدفع العميل ليغلق على نفسه — مع تحديد اللحظة المناسبة للصمت.',
    thumbnail: 'تعبير هادئ وواثق مع نص "قوة الصمت" أو "توقف عن الكلام".',
    cta: 'مشاهدة فيديو سيكولوجية العميل، أو الجسر إلى محتوى MOF أعمق.',
  },
  {
    stage: 'MOF',
    title: 'الرد السحري عندما يقول العميل "سعرك غالي جداً"',
    angle: 'حل المشكلة الأكثر إيلاماً وتحديداً في المجال: اعتراض السعر.',
    intent: 'يبحث تحديداً عن كيفية تجاوز "غالي" دون تقديم أي خصم.',
    premise: '"غالي" غالباً ستار لغياب اليقين؛ سكريبت من ٣ خطوات يتجاوز اعتراض السعر، ويكشف المشكلة الحقيقية، ويغلق الصفقة بالسعر الكامل بلا خصم.',
    thumbnail: 'تعبير واثق مع نص "قال غالي؟".',
    cta: 'مشاهدة فيديو عن أخطاء الإغلاق، أو حجز مكالمة استشارية.',
  },
  {
    stage: 'MOF',
  ...
  {
    stage: 'BOF',
    title: 'تحليل مكالمة مبيعات حقيقية: كيف أغلقت صفقة بـ ٥٠٠٠ دولار',
    angle: 'الإثبات الحيّ — مشاهدة الخبيرة تطبّق المهارة فعلاً لا مجرد الحديث عنها.',
    intent: 'سئم النظريات ويريد أن يرى الإغلاق يحدث أمامه على أرض الواقع.',
    premise: 'تشغيل تسجيل مكالمة حقيقية (أو رول-بلاي مباشر مع طالب) وتفكيك سبب كل جملة، وكيفية التعامل مع المقاومة، والسيكولوجيا خلف الإغلاق.',
    thumbnail: 'لقطة "أثناء العمل" مع نص "مكالمة حقيقية" أو "مسرّبة".',
    cta: 'حجز مكالمة للانضمام إلى البرنامج (أقوى محتوى BOF إقناعاً).',
  },
  {
    stage: 'BOF',
    title: 'كيف تحوّل [اسم الطالب] من [الوضع السابق] إلى [الوضع الحالي] (مقابلة)',
    angle: 'إثبات اجتماعي عبر قصة تحوّل حقيقية لطالب من خلفية يتماهى معها المشاهد.',
    intent: 'قارب على اتخاذ القرار، ويريد أن يطمئن أن البرنامج ينجح مع شخص بظروف مشابهة لظروفه.',
    premise: 'مقابلة مع [اسم الطالب] يروي فيها نقطة البداية ([الوضع السابق])، واللحظة التي قرر فيها التغيير، وما الذي تبدّل بعد البرنامج، وكيف يبدو واقعه اليوم ([الوضع الحالي]) — بصدق وبلا مبالغة.',
    thumbnail: 'صورة [اسم الطالب] بتعبير واثق، مع نص "من [الوضع السابق] إلى [الوضع الحالي]".',
    cta: 'حجز مكالمة استشارية لمعرفة إن كان البرنامج مناسباً لظروفك.',
  },
  {
    stage: 'BOF',
    title: 'كيف حقّق [اسم الطالب] [المبلغ] خلال [المدة] (مبيعات High-Ticket)',
    angle: 'نتيجة رقمية ملموسة ومحدّدة بإطار زمني — دليل أن النظام يعطي عائداً قابلاً للقياس.',
    intent: 'مهتم بجدية ويريد إثباتاً رقمياً أن المهارة تترجم إلى دخل فعلي خلال مدة معقولة.',
    premise: 'تفكيك رحلة [اسم الطالب] خطوة بخطوة — كيف وصل إلى [المبلغ] في [المدة]: من أين جاءت الصفقات، وما العقبة الأكبر التي تجاوزها، وما الذي يفعله بشكل مختلف عمن يتوقفون مبكراً.',
    thumbnail: 'صورة [اسم الطالب] مع نص "[المبلغ] في [المدة]" وإشارة بصرية إلى النتيجة.',
    cta: 'حجز مكالمة لمعرفة كيف تبني المسار نفسه داخل برنامج Elite Sales Mastery.',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <div className={`${CARD} p-8 md:p-10 mt-8 strat-reveal`}>
            <p className="arabic-prose !text-center text-base md:text-lg text-black/70 max-w-4xl mx-auto">
              هذه الطبقات الثلاث تعمل معاً كنظام مبيعات واحد؛ ففيديوهات الاكتشاف تجلب جمهوراً جديداً، وفيديوهات الثقة تبني العلاقة، وفيديوهات
        ...
        <div className="mb-10 strat-reveal">
          <div className="text-center mb-10">
            <Eyebrow>21 High-Converting Video Ideas</Eyebrow>
