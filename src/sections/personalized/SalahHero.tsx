...
/* ═══════════════════════════════════════════════════════════════════════
   HERO VIDEO — SWAP IN SALAH'S WALKTHROUGH HERE
   ───────────────────────────────────────────────────────────────────────
   ...
   Leave both null to show the branded placeholder (current state — Loom pending).
   ═══════════════════════════════════════════════════════════════════════ */
const HERO_YOUTUBE_ID: string | null = null;
const HERO_LOOM_URL: string | null = null;

const PROSPECT_NAME = 'Salah El Deen';
const PROSPECT_FIRST_NAME = 'Salah';
    ...
    >
      ...
      <div className="hero-content relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="space-y-2 md:space-y-3 mb-8">
          <h1
            dir="rtl"
            className="hero-reveal font-arabic font-black text-black leading-[1.25] tracking-tight whitespace-nowrap"
            style={{ fontSize: 'clamp(0.85rem, 4vw, 3rem)' }}
          >
            من فيديوهات تحوّل بالصدفة
          </h1>
          <h1
            dir="rtl"
            className="hero-reveal font-arabic font-black text-red-500 leading-[1.25] tracking-tight whitespace-nowrap"
            style={{ fontSize: 'clamp(0.85rem, 4vw, 3rem)' }}
          >
            إلى أصلٍ يحوّل بقصد
          </h1>
        ...
        {/* Subheadline */}
        <p dir="rtl" className="hero-reveal font-arabic text-lg md:text-xl text-black/60 max-w-3xl mx-auto leading-relaxed font-medium mb-4">
          صلاح، إنت أصلاً تشغّل ماكينة انتباه على إنستقرام. هذي الخطة تحوّل اليوتيوب إلى مصدر عملاء مستقل يبني الثقة ويؤهّل المتردد قبل ما يوصلك، ويجهّز الحجوزات لـ
          <span className="block mt-1 text-black font-bold">برنامج الإرشاد — B.Fit.</span>
        </p>
        ...
        <p className="hero-reveal arabic-prose !text-center text-base md:text-lg text-black/50 max-w-2xl mx-auto mb-12 font-arabic">
          خطة مبنية على قمعك الشغّال — تحوّل اليوتيوب من فيديوهات تحوّل بالصدفة إلى أصل يحوّل بقصد، وتفتح لك مصدر جمهور ما يعتمد على إنك تنزل ريل كل يوم.
        </p>
